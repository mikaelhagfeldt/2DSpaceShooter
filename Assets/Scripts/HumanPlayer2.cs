...
public class HumanPlayer2 : MonoBehaviour
{
    // Variable to help us increase the speed of the game.
    private float field_movementVelocity = 4f;
    ...
    {
        var local_changedX = CrossPlatformInputManager.GetAxis("Horizontal") * Time.deltaTime * field_movementVelocity;
        ...
        var local_changedY = CrossPlatformInputManager.GetAxis("Vertical") * Time.deltaTime * field_movementVelocity;
